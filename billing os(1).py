...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("Billing OS")
        bg_color="#074463"
        title=Label(self.root,text="BILLING OS",bd=12,relief=GROOVE,bg=bg_color,fg="red",font=("times new roman",30,"bold"),pady=2).pack(fill=X)
        self.soap=IntVar()
        ...
        cname_lbl=Label(F1,text="Customer Name :",fg="yellow",bg=bg_color,font=("times new roman",14,"bold")).grid(row=0,column=0,padx=20,pady=5)
        cname_txt=Entry(F1,width=11,textvariable=self.c_name,font="arial 15",bd=7,relief=SUNKEN).grid(row=0,column=1,pady=5,padx=10)
        cphn_lbl=Label(F1,text="PH No:",fg="yellow",bg=bg_color,font=("times new roman",14,"bold")).grid(row=0,column=2,padx=20,pady=5)
        cphn_txt=Entry(F1,width=11,textvariable=self.c_phon,font="arial 15",bd=7,relief=SUNKEN).grid(row=0,column=3,pady=5,padx=10)
        cbill_lbl=Label(F1,text="Bill Number:",fg="yellow",bg=bg_color,font=("times new roman",14,"bold")).grid(row=0,column=4,padx=20,pady=5)
        ...
        bath_lbl=Label(F2,text="Bath Soap :",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        face_crm_lbl=Label(F2,text="Face Cream :",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        face_w_lbl=Label(F2,text="Face Wash :",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        hair_s_lbl=Label(F2,text="Hair Spray :",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        hair_gel_lbl=Label(F2,text="Hair Gell:",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        body_lbl=Label(F2,text="Body Loshan :",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        g1_lbl=Label(F3,text="Rice (1kg) :",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        g2_lbl=Label(F3,text="Food Oil (1L) :",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        g3_lbl=Label(F3,text="Daal (1Kg):",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        g4_lbl=Label(F3,text="Wheat(1Kg):",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        g5_lbl=Label(F3,text="Suger (1kg):",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        g6_lbl=Label(F3,text="Tea(500g):",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        c1_lbl=Label(F4,text="Maza (1L):",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        c2_lbl=Label(F4,text="Coke (1L)",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        c3_lbl=Label(F4,text="Frooti (1L)",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        c4_lbl=Label(F4,text="ThumbsUp (1L):",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        c5_lbl=Label(F4,text="Limca (1L):",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        c6_lbl=Label(F4,text="Sprite (1L):",font=("times new roman",15,"bold"),bg=bg_color,fg="white").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        m1_lbl=Label(F6,text="Total Cosmetic Price:",bg=bg_color,fg="light green",font=("times new roman",14,"bold")).grid(row=0,column=0,padx=20,pady=1,sticky="w")
        ...
        m2_lbl=Label(F6,text="Total Grocery Price:",bg=bg_color,fg="light green",font=("times new roman",14,"bold")).grid(row=1,column=0,padx=20,pady=1,sticky="w")
        ...
        m3_lbl=Label(F6,text="Total Cold Drink Price:",bg=bg_color,fg="light green",font=("times new roman",14,"bold")).grid(row=2,column=0,padx=20,pady=1,sticky="w")
        ...
        c1_lbl=Label(F6,text="CGST on cosmetics :",bg=bg_color,fg="yellow",font=("times new roman",14,"bold")).grid(row=0,column=3,padx=20,pady=1,sticky="w")
        ...
        c2_lbl=Label(F6,text="CGST on Grocery :",bg=bg_color,fg="yellow",font=("times new roman",14,"bold")).grid(row=1,column=3,padx=20,pady=1,sticky="w")
        ...
        c3_lbl=Label(F6,text="CGST on cosmentics : ",bg=bg_color,fg="yellow",font=("times new roman",14,"bold")).grid(row=2,column=3,padx=20,pady=1,sticky="w")
        ...
        total_btn=Button(btn_f,text="Total",command=self.total,bg="cadetblue",fg="green",pady=10,width=10,bd=4,font="arial 10 bold").grid(row=0,column=0,padx=5,pady=5)
        gbill_btn=Button(btn_f,command=self.bill_area,text="Generate Bill",bg="cadetblue",fg="green",pady=10,width=10,bd=4,font="arial 10 bold").grid(row=0,column=1,padx=5,pady=5)
        clear_btn=Button(btn_f,text="Clear",command=self.clear_data,bg="cadetblue",fg="red",pady=10,width=10,bd=4,font="arial 10 bold").grid(row=0,column=2,padx=5,pady=5)
        exit_btn=Button(btn_f,text="Exit",command=self.Exit_app,bg="cadetblue",fg="red",pady=10,width=10,bd=4,font="arial 10 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
    def total(self):
    ...
    def welcome_bill(self):
        ...
        self.textarea.insert(END,     "\t Welcome Macwin Retail")
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phon.get()=="":
            ...
            if self.rice.get()!=0:
                self.textarea.insert(END, f"\n Rice(1KG)\t\t{self.rice.get()}\t\t{self.g_r_p}")
            if self.food_oil.get()!=0:
                self.textarea.insert(END, f"\n Food Oil(1L)\t\t{self.food_oil.get()}\t\t{self.g_fo_p}")
            if self.daal.get()!=0:
                self.textarea.insert(END, f"\n Daal(1KG)\t\t{self.daal.get()}\t\t{self.g_d_p}")
            if self.wheat.get()!=0:
                self.textarea.insert(END, f"\n Wheat(1KG)\t\t{self.wheat.get()}\t\t{self.g_w_p}")
            if self.sugar.get()!=0:
                self.textarea.insert(END, f"\n Suger(1KG)\t\t{self.sugar.get()}\t\t{self.g_s_p}")
            if self.tea.get()!=0:
                self.textarea.insert(END, f"\n Tea(500G)\t\t{self.tea.get()}\t\t{self.g_t_p}")  
            if self.maza.get()!=0:
                self.textarea.insert(END, f"\n Maza(1L) \t\t{self.maza.get()}\t\t{self.cd_m_p}")
            if self.cock.get()!=0:
                self.textarea.insert(END, f"\n Coke(1L)   \t\t{self.cock.get()}\t\t{self.cd_c_p}")
            if self.frooti.get()!=0:
                self.textarea.insert(END, f"\n Frooti(1L)  \t\t{self.frooti.get()}\t\t{self.cd_f_p}")
            if self.thumbsup.get()!=0:
                self.textarea.insert(END, f"\n Thumbs Up(1L)\t\t{self.thumbsup.get()}\t\t{self.cd_th_p}")
            if self.limca.get()!=0:
                self.textarea.insert(END, f"\n Limca(1L) \t\t{self.limca.get()}\t\t{self.cd_l_p}")
            if self.sprite.get()!=0:
                self.textarea.insert(END, f"\n Sprite(1L) \t\t{self.sprite.get()}\t\t{self.cd_s_p}")
            self.textarea.insert(END, f"\n--------------------------------------")
            if self.cosmetic_tax.get()!="Rs. 0.0":
                self.textarea.insert(END,f"\n CGST on Cosmetic  \t\t\t{self.cosmetic_tax.get()}")
            
            if self.grocery_tax.get()!= "Rs. 0.0":
                self.textarea.insert(END,f"\n CGST on Grocery  \t\t\t{self.grocery_tax.get()}")
                
            if self.cold_drink_tax.get()!=  "Rs. 0.0":
                self.textarea.insert(END,f"\n CGST on Cold Drink \t\t\t{self.cold_drink_tax.get()}")
    ...
    def save_bill(self):
        ...
        if op>0:
            ...
            f1=open("D:\\project\\bill_app\\invoice\\"+str(self.bill_no.get())+".dat","w")
